        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CPR = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ScreeningNotes = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SizeInSqFt = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    MonthlyRent = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    ...
                    CurrentLeaseId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Units_Leases_CurrentLeaseId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", "abd50d47-34de-4624-8f09-3db962e84e59", "Tenant", "TENANT" },
                    { "2", "a9811772-0b21-4ca7-9a68-3e4e3839323d", "PropertyManager", "PROPERTYMANAGER" },
                    { "3", "a171d661-9500-4280-8d81-0d43690d26d0", "MaintenanceStaff", "MAINTENANCESTAFF" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MaintenanceRequests_TicketNumber",
                table: "MaintenanceRequests",
                column: "TicketNumber",
                unique: true);
